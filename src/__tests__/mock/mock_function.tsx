...
import { ToImport } from './mock_import';
...
export const JSXNames = {
    JSXFunctionalNormalTag: JSXFunctionalNormalTag.name,
    JSXFunctionalSelfClosingTag: JSXFunctionalSelfClosingTag.name
}